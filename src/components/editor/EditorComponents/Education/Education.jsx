...
function Education(props) {
    ...
    return (
        <div>
            ...
            <FormInput title="Graduation year" width="100" value={Education.graduationYear} valueBack={gradYearHandler}/>
            <FormInput title="Grade" width="50" value={Education.grade} valueBack={gradeHandler}/>
