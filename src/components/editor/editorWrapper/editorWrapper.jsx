...
function EditorWrapper() {
    ...
    const [personalInfo, setpersonalInfo] = useState({firstName:"",lastName:"",age:"",phoneNumber:""})

    
    const [educationData, seteducationData] = useState({university:"",graduationYear:"",grade:""})
    ...
    return (
        <div className="editorWrapper-container">
            <div className="left-editor w-100 w-md-50">
                ...
                <Switch>
                    <Route path="/Editor/PersonalInfo" render={()=> <PersonalInfo data={personalInfo} setPersonalData={personalHandler}></PersonalInfo>}/>
                    <Route path="/Editor/Education" render={()=> <Education data={educationData} setEducationData={educationHandler}></Education>}/>
